      ...
      >
        <h1
          className={clsx(
            ...
            "text-3xl md:text-8xl text-center font-extrabold",
        ...
        >
         Oye beba..Quieres ser mi San Valentin?
        </h1>
        <div
          className={clsx(
        ...
        <footer className="row-start-4 col-start-1 col-span-12 flex justify-center items-end text-center text-white/15">
          <a
            ...
            rel="noopener"
          >
            Puedes decirme que no si quieres, pero al final te casarás conmigo
          </a>
        </footer>
      </main>
    </>
